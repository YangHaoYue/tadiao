<template>
	<view class="wrap">
		...
		<!-- 轮播图 -->
		<u-swiper class="u-p-20" style="padding-bottom: 0 !important;" :list="imgList" height="269"></u-swiper>
		<!-- 塔吊列表 -->
		<u-dropdown ref="uDropdown" activeColor="#0F58FB">
			...
			<u-dropdown-item :title="brand" style="z-index: 9999;">
				<view class="slot-content">
					<scroll-view scroll-y style="height: 200rpx;" @scrolltolower="brandOnReachBottom" lower-threshold="50">
						<view class="item-box">
		...
		<!-- 列表 -->
		<u-row class="u-p-20" gutter="20" justify="space-between">
			<view 
...
<script>
	...
	export default {
		...
		methods: {
			...
			getBanner(){
				this.http.get('Index/index',{},true).then(res=>{
					if(res.code == 1000){
